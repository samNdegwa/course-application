...
$pdf->Cell(100,10,'Idle Simcards as at '.$date,0,0);
$pdf->Cell(50,10,'',0,0);
$pdf->Cell(0,10,'',0,1);
...
$pdf->SetFont('Arial', '',9);
$sql="SELECT * FROM tb_sim_cards WHERE status='0' ORDER BY sim_id ASC";
...
while($row=mysqli_fetch_array($result))
{
    $identifier=$row['identifier'];
     ...
     $status=$row['status'];
    $pdf->Cell(10,4,$no,1,0);
    $pdf->Cell(60,4,$identifier,1,0);
    $pdf->Cell(50,4,$network,1,0);
    $pdf->Cell(50,4,$sim_type,1,0);
    $pdf->Cell(25,4,'Idle',1,1);
