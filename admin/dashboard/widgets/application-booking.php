...
<div class="card">
  <div class="card-header">
    <h6 class="btn-secondary" style="padding-left:5px;"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> A. Course Applied</h6>
  </div>
  <div class="card-body">
  <div class="table-responsive">
  <?php
    $sql="SELECT * FROM applicants INNER JOIN courses ON applicants.course_id=courses.course_id WHERE batch_id='$code' AND applicants.status='1'";
