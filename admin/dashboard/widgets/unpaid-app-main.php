...
<div class="card">
  <div class="card-header">
    <h6 class="btn-secondary" style="padding-left:5px;"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> A. Courses Applied</h6>
  </div>
  <div class="card-body">
    ...
    <tbody>
      ...
      { 
        ...
        <tr>
        	...
        	<td><?php echo $row['min_grade'].' '.$row['second_name'].' '.$row['last_name'];?></td>
