...
<img src="'.$src.'" style="width:100%"><br>
     ...
     <p>
       I am pleased to congratulate you on securing a chance at our college for a <b>'.$couese_name.'</b>.  This course runs for <b>one (1) year </b> years on full time basis. The reporting date shall be on the <b>'.$report_date.'</b> at <b>8:30 a.m.</b>
     </p>
     <p>
      Please note that your registration process shall be completed on the admission day upon receipt and verification of the under listed items: 
        ...
        <ol type="i">
          ...
          <li>Certified copies of National ID (1), KCSE Certificate, High School Leaving Certificate (1) </li> 

          <li>Springs files (2) and recently taken passport sized photos (2) </li> 

          <li>Original KSCE certificate</li> 

         <li>Copy of Admission Agreement Form duly signed </li>

        </ol>
   
        <p>Further note that you shall present your laptop for verification of availability of the required e-books.</p>   
